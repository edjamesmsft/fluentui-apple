...
class DatePickerController: UIViewController, GenericDateTimePicker {
    ...
    public override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        if let segmentedControl = segmentedControl, previousTraitCollection?.userInterfaceStyle != traitCollection.userInterfaceStyle {
            segmentedControl.style = (traitCollection.userInterfaceStyle == .dark) ? .onBrandPill : .neutralPill
        }
    }
    ...
    private func initSegmentedControl() {
            ...
            let segmentedControl = SegmentedControl(items: items,
                                                style: traitCollection.userInterfaceStyle == .dark ? .onBrandPill : .neutralPill)
